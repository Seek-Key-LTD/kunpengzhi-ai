...
class RobertTokenRingEngine:
    ...
    def draft_official_indictment(self):
        ...
        prompt = (
            ...
            "3. 无息即人情定价：2016年民间拆借市场月息2分起步，1000万一年利息约240万，被告人放弃全部利息，是以人情债替代金钱对价——人情债无账目、不可审计；\n"
